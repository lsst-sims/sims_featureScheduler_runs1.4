...
def generate_blobs(nside, nexp=1, exptime=30., filter1s=['u', 'u', 'u', 'g', 'r', 'i', 'z', 'y'],
                   ...
                   stayfilter_weight=3., template_weight=12., search_radius=30.):
    """
    ...
    blob_survey_params = {'slew_approx': 7.5, 'filter_change_approx': 140.,
                          'read_approx': 2., 'min_pair_time': 15., 'search_radius': search_radius,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--search_radius", type=float, default=30)
    ...
    fileroot = 'radius_constrict_%i_' % search_radius
    file_end = 'v1.4_'
    ...
    blobs = generate_blobs(nside, nexp=nexp, search_radius=search_radius)
