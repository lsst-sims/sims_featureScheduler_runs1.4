...
def generate_blobs(nside, nexp=1, exptime=30., filter1s=['u', 'u', 'u', 'g', 'r', 'i', 'z', 'y'],
                   ...
                   stayfilter_weight=3., template_weight=12., kernel_fwhm=None):
    """
    ...
    blob_survey_params = {'slew_approx': 7.5, 'filter_change_approx': 140.,
                          ...
                          'twilight_scale': True}
    blob_survey_params['smoothing_kernel'] = kernel_fwhm
...
if __name__ == "__main__":
    ...
    parser.add_argument("--kernel_fwhm", type=float, default=30.)
    ...
    fileroot = 'smooth_reward_%i_' % kernel_fwhm
    file_end = 'v1.4_'
    ...
    blobs = generate_blobs(nside, nexp=nexp, kernel_fwhm=kernel_fwhm)
