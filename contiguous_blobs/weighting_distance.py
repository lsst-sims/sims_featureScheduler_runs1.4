...
def generate_blobs(nside, nexp=1, exptime=30., filter1s=['u', 'u', 'u', 'g', 'r', 'i', 'z', 'y'],
                   ...
                   stayfilter_weight=3., template_weight=12., distance_weight=0.):
    """
    ...
    blob_survey_params = {'slew_approx': 7.5, 'filter_change_approx': 140.,
                          ...
                          'twilight_scale': True, 'distance_weight': distance_weight}
...
if __name__ == "__main__":
    ...
    fileroot = 'weighting_distance_%.1f_' % distance_weight
    file_end = 'v1.4_'
    ...
    blobs = generate_blobs(nside, nexp=nexp, distance_weight=distance_weight)
