...
import os
import argparse
import survey_footprints as sfp
...
if __name__ == "__main__":
    ...
    parser.add_argument("--footprint_name", type=str, default="standard_goals")
    ...
    footprint_name = args.footprint_name
    ...
    fileroot = 'footprint_%s' % footprint_name
    file_end = 'v1.4_'

    footprints = getattr(sfp, footprint_name)(nside=nside)
