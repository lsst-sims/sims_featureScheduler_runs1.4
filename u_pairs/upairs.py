...
if __name__ == "__main__":
    ...
    parser.add_argument("--u_scaleup", type=float, default=1.)
    ...
    fileroot = 'uparis_illum_%i_scale%i' % (illum_limit, u_scaleup)
    file_end = 'v1.4_'

    footprints = standard_goals(nside=nside)
    footprints['u'] = u_scaleup*footprints['u']
