...
if __name__ == "__main__":
    ...
    all_twilight_filters = ['g', 'r', 'i', 'z', 'y']
    filters_indx = len(all_twilight_filters) - n_filters
    filters = all_twilight_filters[filters_indx:]
    ...
    fileroot = 'twi_filters_%i_' % n_filters
    file_end = 'v1.4_'
    ...
    greedy = gen_greedy_surveys(nside, nexp=nexp, filters=filters)
